...
def initialize_block_and_state(n_validators):
    ...
    """
    from block import QC, Block, LedgerCommitInfo, VoteInfo
    from ledger import NoopTxnEngine
    ...
    qc_ledger_commit_info_2 = LedgerCommitInfo(state_1, None)
    ...
    round_3 = -1
    payload_3 = 'GENESYS+2'
    qc_vote_info_3 = VoteInfo(block_2_id, round_2, block_1_id, round_1, state_2.state_id)
    qc_ledger_commit_info_3 = LedgerCommitInfo(state_2, None)
    qc_3 = QC(qc_vote_info_2, qc_ledger_commit_info_2, None, author_2, None)
